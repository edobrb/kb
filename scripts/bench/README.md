...
They read the real `kb/` and the real `.env`, so re-run them after changing a model or a chunking dial
...
# Does a change to chunking / the embedder help or hurt retrieval?
